...
import AddNextMaintenance from './AddNextMaintenance';
...
export default function Dashboard() {
  ...
  if(selectedContent=='Next maintenances'){
    mainContent=
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <Paper className={classes.paper}>
            <AddNextMaintenance setRefresh={setRefresh}/>
          </Paper>
        </Grid>  
        {/*NextMaintenances */}
        <Grid item xs={12}>
  ...
  if(selectedContent=='Add maintenance'){
    mainContent=
      <Grid container spacing={3}>
        {/* SelectedVehicle */}
        <Grid item xs={12}>
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <List>
          ...
          <ListItem button onClick={()=>{setselectedContent('Add maintenance')}}>
            <ListItemIcon>
              <LibraryAddIcon />
            </ListItemIcon>
